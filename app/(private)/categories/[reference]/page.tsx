    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
            ...
            {kategoria.semikategorias.length === 0 ? (
              ...
              <div className="space-y-3">
                {kategoria.semikategorias.map((sub) => (
                  <div
                    key={sub.reference}
                    className="p-4 bg-gray-50 rounded-2xl flex items-center justify-between group hover:bg-emerald-50 transition-colors cursor-default"
                  >
